    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                ...
                <p class="">Here You Will Add New Size.</p>

                <form id="sizeAdd" action="{{ route('admin.sizes.store') }}" method="post" enctype="multipart/form-data" class="mt-5">
                    @csrf
                    <div class="row justify-content-center">
                        <div class="col-md-12">

                            <div class="form-group row">
                                <label for="example-text-input" class="col-md-2 col-form-label">Product Size Name</label>
                                <div class="col-md-10">
...
@push('js')
    <script>
       ...
       $(document).ready(function () {
            ajaxFormSubmitJQ('#sizeAdd', {
                url: "{{ route('admin.sizes.store') }}",
                method: 'POST',
                onSuccess: function (response) {
                    window.location.href = "{{ route('admin.sizes.index') }}";
                    toastr.success(response.message || 'Size added successfully!');
                }
            });
        });
