    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                ...
                <p class="">Here You Will Edit Size.</p>

                <form id="sizeEdit" action="{{ route('admin.sizes.update', $size->id) }}" method="post" enctype="multipart/form-data" class="mt-5">
                    @csrf
                    @method('PUT')
                    <div class="row justify-content-center">
                        <div class="col-md-12">
                            ...
                            <div class="form-group row">
                                <label for="example-text-input" class="col-md-2 col-form-label">Size Name</label>
                                <div class="col-md-10">
                                    <input class="form-control" type="text" name="name" value="{{ $size->name }}" id="example-text-input">
                                </div>
                            </div>
